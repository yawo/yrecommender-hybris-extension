...
import com.yreco.constants.YrecommenderConstants;



/**
 * This is the extension manager of the Yrecommender extension.
 */
public class YrecommenderManager extends GeneratedYrecommenderManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YrecommenderManager.class.getName());
	 ...
	 */
	public static YrecommenderManager getInstance()
	{
		return (YrecommenderManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				YrecommenderConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YrecommenderManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YrecommenderManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YrecommenderManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YrecommenderManager called, current tenant: " + getTenant().getTenantID());
		}
	}
