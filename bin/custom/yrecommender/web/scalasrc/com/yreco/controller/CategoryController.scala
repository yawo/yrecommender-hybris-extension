...
import com.yreco.dto.CategoryDTO
import com.yreco.facade.CategoryFacade
...
class CategoryController {
   ...
   * Request URL: http://server:port/yrecommender/categories
   * Method: POST
   * JSON:
   * {
   *  "code": "CateogyCode",
   ...
   * Request URL: http://server:port/yrecommender/catalogID/catalogVersion/categoryCode
   * Method: DELETE
   */
