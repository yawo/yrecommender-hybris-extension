...
import com.yreco.dto.{ProductDTO, ProductsDTO}
import com.yreco.facade.ProductFacade
...
class ProductController {
  ...
  /**
   * Creates new Product.
   * Request URL: http://server:port/yrecommender/products
   * Method: POST
   * JSON:
   * {
   * "code": "product_code",
   ...
   * Request URL: http://server:port/yrecommender/products/catalogID/catalogVersion/productCode
   * Method: PUT
   * <pre>
   * {
   ...
   * Request URL: http://server:port/yrecommender/products/catalogID/catalogVersion
   */
